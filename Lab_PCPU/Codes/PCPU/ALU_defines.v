...
`define ALU_DEFINES_V
  ...
  `define ALUCtrl_SLT   5'd3
  `define ALUCtrl_SLTU  5'd4
  
  `define ALUCtrl_DIV   5'd5
  `define ALUCtrl_DIVU  5'd6
  `define ALUCtrl_MULT  5'd7
  `define ALUCtrl_MULTU 5'd8
